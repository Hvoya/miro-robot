  ...
  <ProjectPageTemplate>
    <div class="singe-project">
      ...
      <a-card>
        <a-row :gutter="30">
          <a-col :span="14">
            <h4 class="single-project_sub-heaidng gallery-heading">
              {{ $t("headings.gallery") }}
            </h4>
          ...
          <a-col :span="10">
            <h4 class="single-project_sub-heaidng statistics-heading">
            ...
            <h4 class="single-project_sub-heaidng">
          ...
          <a-col :span="16">
            <a-tabs defaultActiveKey="1">
              ...
              <a-tab-pane :tab="$t('headings.comments_tab')" key="2">
                <a-comment
                  v-for="comment of project.comments"
                  :key="comment.id"
                >
                  <router-link
                    slot="author"
                  ...
                  <a-avatar
                    @click="
                      () => $router.push(`/projects/users/${comment.user.id}`)
                    "
              ...
              <a-tab-pane
                class="save-comment-tab"
                :tab="$t('headings.add_comment')"
              >
                <h4 class="comment-heading">
                  {{ $t("headings.add_comment") }}:
                </h4>
                <quill-editor
                  v-model="comment"
                  :disabled="!user"
                ...
                <a-button
                  ...
                  >{{
                    !user ? $t("errors.only_user_comments") : $t("buttons.save")
                  }}</a-button
                >
              </a-tab-pane>
            </a-tabs>
